...
public class DoOrder extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String [] checked = request.getParameterValues("checkbook");
        ...
        for(int i=0;i<checked.length;i++){
            myOrder.add(Integer.parseInt(checked[i]));
        }
        
        DAO dao = new DAO();
        dao.makeOrder(myOrder);
        ArrayList<Books> books = dao.getBooksOfUser(idUser);
